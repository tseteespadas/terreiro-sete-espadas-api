...
router.get(
  ...
  handle(async (req, res) => {
    try {
      ...
      const cursos = await DesenvolvimentoCourse.find({});
...
router.post(
  ...
  handle(async (req, res) => {
    try {
      ...
      const novoCurso = await DesenvolvimentoCourse.create(req.body);
...
module.exports = (app) => app.use("/cursos/desenvolvimento", router);
